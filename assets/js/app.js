const terms = [
    ...
    { term: "Attack Surface Management (ASM)", tag: "defense", def: "Descoberta e redução contínua de exposições internas e externas." },
    ...
    { term: "Bootkit", tag: "malware", def: "Malware que compromete cadeia de boot para persistência profunda." },
    ...
    { term: "Brute Force", tag: "pentest", def: "Tentativa sistemática de senhas/chaves até obter acesso." },
    { term: "Buffer Overflow", tag: "pentest", def: "Sobrescrita de memória por excesso de dados além do limite do buffer." },
    ...
    { term: "CAASM", tag: "defense", def: "Gestão de superfície de ataque orientada a ativos cibernéticos." },
    { term: "CAPTCHA Bypass", tag: "web", def: "Contorno de CAPTCHA por falha lógica, automação ou serviços externos." },
    ...
    { term: "Credential Harvesting", tag: "social", def: "Coleta em massa de credenciais por páginas falsas e engenharia social." },
    { term: "Credential Stuffing", tag: "pentest", def: "Uso de credenciais vazadas em serviços diferentes." },
    { term: "Cryptojacking", tag: "malware", def: "Uso não autorizado de recursos para mineração de criptoativos." },
    { term: "CSRF (Cross-Site Request Forgery)", tag: "web", def: "Execução de ação indesejada no contexto autenticado da vítima." },
    { term: "CVE (Common Vulnerabilities and Exposures)", tag: "defense", def: "Identificador padrão de vulnerabilidades públicas." },
    { term: "CVSS", tag: "defense", def: "Sistema de pontuação de severidade de vulnerabilidades." },
    { term: "CWPP", tag: "defense", def: "Proteção de workloads em nuvem com foco em comportamento e runtime." },
    { term: "Cyber Espionage", tag: "defense", def: "Roubo silencioso de informação estratégica por longo prazo." },
    ...
    { term: "DAST", tag: "web", def: "Teste dinâmico de segurança em aplicação em execução." },
    ...
    { term: "Domain Fronting", tag: "pentest", def: "Máscara destino real de tráfego usando infraestrutura intermediária." },
    { term: "Doxxing", tag: "social", def: "Exposição pública de dados pessoais sem consentimento." },
    { term: "Drive-by Download", tag: "web", def: "Download/infecção automática ao visitar página comprometida." },
    { term: "Dropper", tag: "malware", def: "Malware de estágio inicial que instala payload secundário." },
    { term: "DREAD", tag: "defense", def: "Método de avaliação de risco por cinco fatores de impacto/exploração." },
    { term: "EASM", tag: "defense", def: "Gestão da superfície de ataque externa exposta na internet." },
    { term: "EDR", tag: "defense", def: "Detecção e resposta em endpoint com telemetria e ação rápida." },
    { term: "Email Spoofing", tag: "social", def: "Falsificação de remetente em mensagens de e-mail." },
    ...
    { term: "Evil Twin", tag: "network", def: "Ponto de acesso Wi-Fi falso para interceptação de tráfego." },
    { term: "Exploit", tag: "pentest", def: "Código/ação que explora vulnerabilidade para causar impacto." },
    { term: "Exploit Development", tag: "pentest", def: "Criação de exploit funcional para vulnerabilidade específica." },
    { term: "Exposure Management", tag: "defense", def: "Priorização e redução de exposições reais com contexto de risco." },
    { term: "False Positive / False Negative", tag: "defense", def: "Balanceamento entre alerta incorreto e ameaça não detectada." },
    { term: "File Inclusion (LFI/RFI)", tag: "web", def: "Inclusão indevida de arquivos locais/remotos por falha de validação." },
    { term: "Fileless Malware", tag: "malware", def: "Malware que opera sem arquivo em disco, geralmente em memória." },
    { term: "Firewall", tag: "defense", def: "Filtro de tráfego de rede baseado em política de segurança." },
    { term: "Forensic Imaging", tag: "forensics", def: "Cópia bit a bit para análise sem alterar evidência original." },
    ...
    { term: "GPO Abuse", tag: "pentest", def: "Abuso de Group Policy para executar ação maliciosa em massa." },
    ...
    { term: "Hash Cracking", tag: "pentest", def: "Recuperação de senha a partir de hash por ataques offline." },
    { term: "Heap Spray", tag: "pentest", def: "Alocação massiva de payload para aumentar chance de execução." },
    { term: "Honey Pot", tag: "defense", def: "Sistema isca para atrair atacante e coletar inteligência." },
    ...
    { term: "IAM", tag: "defense", def: "Gestão de identidades e acessos em sistemas e nuvem." },
    { term: "IAST", tag: "web", def: "Teste de segurança com instrumentacao durante execução da aplicação." },
    { term: "IDOR", tag: "web", def: "Falha de autorização por referência direta a objeto." },
    ...
    { term: "Incident Response Plan (IRP)", tag: "defense", def: "Plano formal de preparação, contenção, erradicação e recuperação." },
    { term: "Infostealer", tag: "malware", def: "Malware focado em credenciais, cookies, tokens e carteiras." },
    { term: "Injection (SQL, Command, LDAP)", tag: "web", def: "Entrada não confiável interpretada como comando/código." },
    ...
    { term: "Kubernetes Hardening", tag: "defense", def: "Boas práticas de segurança para clusters e workloads Kubernetes." },
    ...
    { term: "LOLBAS / LOLBins", tag: "pentest", def: "Binários nativos explorados para execução e evasao." },
    ...
    { term: "NHI (Non-Human Identity)", tag: "defense", def: "Identidade de máquina/serviço para autenticação entre sistemas." },
    { term: "NIST Cybersecurity Framework (NIST CSF)", tag: "defense", def: "Framework de referência para governança de segurança." },
    ...
    { term: "OAuth Misconfiguration", tag: "web", def: "Falhas de implementação OAuth/OIDC com risco de takeover." },
    ...
    { term: "OSINT", tag: "pentest", def: "Coleta de inteligência por fontes públicas abertas." },
    { term: "OWASP Top 10", tag: "web", def: "Lista de riscos web mais críticos para conscientização e mitigação." },
    { term: "PAM", tag: "defense", def: "Gestão e controle de acessos privilegiados." },
    ...
    { term: "Patch Management", tag: "defense", def: "Gestão de atualizações de segurança e remediação de CVEs." },
    ...
    { term: "PKI", tag: "crypto", def: "Infraestrutura de chaves públicas e certificados digitais." },
    { term: "Port Scanning", tag: "pentest", def: "Mapeamento de portas abertas para identificar superfície de ataque." },
    { term: "Post-Exploitation", tag: "pentest", def: "Fase de consolidação após acesso inicial." },
    ...
    { term: "Quarantine", tag: "defense", def: "Isolamento de host/arquivo para contenção de incidente." },
    ...
    { term: "Reverse Engineering", tag: "forensics", def: "Análise de binários para entender lógica interna." },
    { term: "Reverse Shell", tag: "pentest", def: "Shell em que a vítima inicia conexão para o atacante." },
    { term: "Risk-Based Vulnerability Management (RBVM)", tag: "defense", def: "Priorização de vulnerabilidades por risco real." },
    { term: "Rootkit", tag: "malware", def: "Malware de ocultacao e persistência em alto privilégio." },
    { term: "Runtime Application Self-Protection (RASP)", tag: "defense", def: "Proteção embarcada na aplicação durante execução." },
    ...
    { term: "SIEM", tag: "defense", def: "Correlação de logs para detecção e investigação." },
    ...
    { term: "SOAR", tag: "defense", def: "Orquestracao e automação de resposta a incidentes." },
    ...
    { term: "STIX/TAXII", tag: "defense", def: "Padrões de representação e troca de threat intelligence." },
    { term: "Subdomain Takeover", tag: "web", def: "Sequestro de subdomínio por dangling DNS." },
    ...
    { term: "Threat Feed", tag: "defense", def: "Fluxo contínuo de inteligência de ameaças." },
    { term: "Threat Hunting", tag: "defense", def: "Busca proativa de ataque não detectado por regras comuns." },
    { term: "Threat Intelligence", tag: "defense", def: "Conhecimento acionável sobre atores, TTPs e indicadores." },
    ...
    { term: "Triage", tag: "defense", def: "Classificação de alertas por criticidade e prioridade de resposta." },
    ...
    { term: "User Awareness Training", tag: "defense", def: "Treinamento contínuo contra phishing, fraude e erro operacional." },
    ...
    { term: "Vulnerability Assessment", tag: "pentest", def: "Identificacao e classificação de vulnerabilidades sem exploração total." },
    ...
    { term: "YARA", tag: "forensics", def: "Linguagem de regras para identificar malware por padrão." },
    { term: "Zero-Day (0-day)", tag: "pentest", def: "Vulnerabilidade sem patch disponivel no momento da exploração." },
    { term: "Zero Trust", tag: "defense", def: "Modelo de acesso sem confiança implícita e verificação contínua." },
    ...
    { term: "Account Checker", tag: "social", def: "Automação para validar combinacoes usuário/senha oriundas de vazamentos." },
    { term: "Amcache", tag: "forensics", def: "Artefato do Windows com histórico de execução de binários para investigação." },
    ...
    { term: "Artifact Triage", tag: "forensics", def: "Priorização rápida de artefatos relevantes durante resposta a incidente." },
    ...
    { term: "Conditional Access", tag: "defense", def: "Políticas de acesso baseadas em contexto, risco e postura de dispositivo." },
    ...
    { term: "Identity Governance and Administration (IGA)", tag: "defense", def: "Governança de ciclo de vida de identidades, acessos e recertificacao." },
    ...
    { term: "Kubernetes RBAC Abuse", tag: "defense", def: "Escalada em cluster por permissões excessivas em roles e bindings." },
    { term: "Loader Malware", tag: "malware", def: "Malware especializado em entregar payloads adicionais e manter cadeia de infecção." },
    ...
    { term: "Memory Forensics", tag: "forensics", def: "Análise de memória volatil para encontrar processos, injeções e credenciais." },
    ...
    { term: "OTP Bot", tag: "social", def: "Automação de chamadas/mensagens para coletar OTP em tempo real." },
    ...
    { term: "Process Hollowing", tag: "malware", def: "Técnica de injecao que substitui memória de processo legitimo por payload." },
    { term: "Refund Fraud", tag: "social", def: "Fraude que explora políticas de reembolso com identidade/compra comprometida." },
    { term: "Reflective DLL Injection", tag: "malware", def: "Carregamento de DLL diretamente em memória sem uso convencional de disco." },
    { term: "Registry Forensics", tag: "forensics", def: "Investigação de chaves/valores do registro para persistência e timeline." },
    { term: "SAML Token Forgery", tag: "defense", def: "Falsificação de token SAML para impersonação em ambientes federados." },
    ...
    { term: "Service Principal Abuse", tag: "defense", def: "Abuso de identidades de aplicação com permissões excessivas em cloud." },
    ...
    { term: "Sigma Rules", tag: "defense", def: "Padrão generico para descrever regras de detecção convertiveis para SIEM/EDR." },
    ...
    { term: "Web Inject", tag: "malware", def: "Injecao maliciosa em páginas para capturar credenciais e dados financeiros." },
    { term: "Workload Identity Federation", tag: "defense", def: "Federação de identidade de workload sem segredo estático de longa duracao." },
    ...
    { term: "Jailbreak/Root Detection Bypass", tag: "mobile", def: "Técnicas para contornar válidações de root/jailbreak em aplicativos." },
    { term: "MAST (Mobile Application Security Testing)", tag: "mobile", def: "Conjunto de técnicas para avaliar segurança de apps mobile em estático e dinâmico." },
    { term: "Mobile Device Management (MDM)", tag: "mobile", def: "Gestão centralizada de políticas, configuração e conformidade de dispositivos móveis." },
    { term: "Mobile Threat Defense (MTD)", tag: "mobile", def: "Controles para detectar phishing, malware e risco de rede em dispositivos móveis." },
    { term: "Smali", tag: "mobile", def: "Linguagem intermediaria Dalvik usada em análise e modificação de APKs." },

    { term: "Adversary Emulation", tag: "pentest", def: "Simulação de TTPs de grupos reais para validar controles e detecções." },
    { term: "Android Exported Components Abuse", tag: "mobile", def: "Abuso de componentes exportados para executar ações sem autorização adequada." },
    { term: "API Pentesting", tag: "web", def: "Avaliação de segurança em APIs REST/GraphQL focando autenticação, autorização e lógica." },
    ...
    { term: "DMA Attack", tag: "pentest", def: "Ataque via acesso direto a memória por interfaces/perifericos." },
    ...
    { term: "Hardware Implant", tag: "pentest", def: "Dispositivo inserido fisicamente para espionagem, persistência ou exfiltração." },
    ...
    { term: "Red Team Infrastructure (RTI)", tag: "pentest", def: "Conjunto de domínios, redirectors, C2 e automação para operação red team." },
    ...
    { term: "USB Rubber Ducky", tag: "pentest", def: "Dispositivo de emulacao HID para automação de comandos em testes físicos." }
];
...
function localizeDefinition(definition) {
    const ptBrAccentFixes = [
        [/\bmineracao\b/gi, "mineração"],
        [/\bprotecao\b/gi, "proteção"],
        [/\bdecisoes\b/gi, "decisões"],
        [/\busuario\b/gi, "usuário"],
        [/\busuarios\b/gi, "usuários"],
        [/\blegitima\b/gi, "legítima"],
        [/\binteracao\b/gi, "interação"],
        [/\binterceptacao\b/gi, "interceptação"],
        [/\bautenticacao\b/gi, "autenticação"],
        [/\bautorizacao\b/gi, "autorização"],
        [/\bpraticas\b/gi, "práticas"],
        [/\binjecoes\b/gi, "injeções"],
        [/\bcatalogo\b/gi, "catálogo"],
        [/\bpriorizacao\b/gi, "priorização"],
        [/\bexploraveis\b/gi, "exploráveis"],
        ...
        [/\bpersistencia\b/gi, "persistência"],
        [/\bsistematica\b/gi, "sistemática"],
        [/\bate\b/gi, "até"],
        [/\balem\b/gi, "além"],
        [/\bsuperficie\b/gi, "superfície"],
        [/\bcibernetico\b/gi, "cibernético"],
        [/\bciberneticos\b/gi, "cibernéticos"],
        [/\bgestao\b/gi, "gestão"],
        [/\bautomacao\b/gi, "automação"],
        [/\btecnica\b/gi, "técnica"],
        [/\btecnicas\b/gi, "técnicas"],
        [/\breplicacao\b/gi, "replicação"],
        [/\bdominio\b/gi, "domínio"],
        [/\bbinario\b/gi, "binário"],
        [/\bbinarios\b/gi, "binários"],
        [/\bcodigo\b/gi, "código"],
        [/\bnivel\b/gi, "nível"],
        [/\bconteudo\b/gi, "conteúdo"],
        [/\bpainels\b/gi, "painéis"],
        [/\bpaineis\b/gi, "painéis"],
        [/\bmultiplas\b/gi, "múltiplas"],
        [/\bcriacao\b/gi, "criação"],
        [/\bmanutencao\b/gi, "manutenção"],
        [/\bdeteccao\b/gi, "detecção"],
        [/\bdeteccoes\b/gi, "detecções"],
        [/\banalise\b/gi, "análise"],
        [/\binvestigacao\b/gi, "investigação"],
        ...
        [/\bsobreposicao\b/gi, "sobreposição"],
        [/\bmascara\b/gi, "máscara"],
        [/\bintermediaria\b/gi, "intermediária"],
        ...
        [/\bcontencao\b/gi, "contenção"],
        [/\berradicacao\b/gi, "erradicação"],
        [/\brecuperacao\b/gi, "recuperação"],
        [/\bconfiavel\b/gi, "confiável"],
        [/\bameaca\b/gi, "ameaça"],
        [/\bameacas\b/gi, "ameaças"],
        [/\bmaquina\b/gi, "máquina"],
        [/\breferencia\b/gi, "referência"],
        [/\bgovernanca\b/gi, "governança"],
        ...
        [/\bideologica\b/gi, "ideológica"],
        [/\balocacao\b/gi, "alocação"],
        [/\bexecucoes\b/gi, "execuções"],
        [/\bimplementacao\b/gi, "implementação"],
        [/\bsubdominio\b/gi, "subdomínio"],
        [/\btaticas\b/gi, "táticas"],
        [/\badversarios\b/gi, "adversários"],
        [/\blogica\b/gi, "lógica"],
        [/\bpresenca\b/gi, "presença"],
        [/\batribuicao\b/gi, "atribuição"],
        ...
        [/\bestagios\b/gi, "estágios"],
        [/\bsecundario\b/gi, "secundário"],
        [/\bmanipulacao\b/gi, "manipulação"],
        [/\bexfiltracao\b/gi, "exfiltração"],
        [/\binclusao\b/gi, "inclusão"],
        [/\bvalidacao\b/gi, "validação"],
        [/\bmetodo\b/gi, "método"],
        [/\bcopia\b/gi, "cópia"],
        [/\bcriticos\b/gi, "críticos"],
        [/\bconscientizacao\b/gi, "conscientização"],
        [/\bmitigacao\b/gi, "mitigação"],
        [/\bclassificacao\b/gi, "classificação"],
        [/\bcriticidade\b/gi, "criticidade"],
        [/\bprioridade\b/gi, "prioridade"],
        [/\bmutacoes\b/gi, "mutações"],
        [/\bfisico\b/gi, "físico"],
        [/\bfisicos\b/gi, "físicos"],
        [/\bproprio\b/gi, "próprio"],
        [/\bsimulacao\b/gi, "simulação"],
        [/\bviolacao\b/gi, "violação"],
        [/\bprontidao\b/gi, "prontidão"],
        [/\bpremissa\b/gi, "premissa"],
    ...
    const withAccents = ptBrAccentFixes.reduce((text, [pattern, replacement]) => text.replace(pattern, replacement), definition);
    return lexicalTranslations.reduce((text, [pattern, replacement]) => text.replace(pattern, replacement), withAccents);
}
...
function getLabExample(termObj) {
    const exactLabs = {
        "SQL Injection (SQLi)": "DVWA em VM Linux + Kali com Burp Suite para validar SQLi e mitigação com consultas parametrizadas.",
        "XSS": "DVWA ou OWASP Juice Shop em ambiente isolado para reproduzir XSS refletido/armazenado e validar CSP/encoding.",
        "SSRF": "OWASP Juice Shop com serviço interno simulado em Docker para testar impacto de SSRF em laboratório.",
        "API Pentesting": "API de treino (crAPI ou Juice Shop API) em VM dedicada para testar autenticação, autorização e lógica.",
        "BOLA (Broken Object Level Authorization)": "Cenário de API REST em lab para comparar acesso entre usuários distintos e verificar controle de objeto.",
        "Kerberoasting": "Lab Active Directory com Windows Server e cliente Windows para detectar contas vulneráveis com SPN em ambiente controlado.",
        "AS-REP Roasting": "Domínio de laboratório com contas sem pre-auth para análise de risco e endurecimento de políticas Kerberos.",
        "DCSync": "AD lab isolado para validação de permissões de replicação e criação de detecção no SIEM.",
        "NTLM Relay": "Rede de laboratório com serviços legados para simular relay e testar mitigação com assinatura e hardening.",
        "Pass-the-Hash (PtH)": "Ambiente Windows controlado para estudar movimento lateral e validar medidas de contenção de credenciais.",
        "Cobalt Strike Beacon": "Simulação de beacon em laboratório autorizado para mapear telemetria e melhorar regras de detecção.",
        "Sliver C2": "C2 em rede interna de laboratório com hosts instrumentados para exercício purple team.",
        "Phishing": "Campanha interna em ambiente de treino com GoPhish e contas de teste para medir resposta de usuários e SOC.",
        "Android Malware Analysis": "Análise de APK em emulador Android isolado com MobSF/Jadx para avaliação estática e dinâmica.",
        "Frida": "Instrumentação de app de teste em emulador Android para observar chamadas sensíveis durante execução.",
        "Memory Forensics": "Aquisição de memória de VM comprometida e investigação com Volatility em caso simulado de incidente.",
        "Timeline Analysis": "Construção de timeline DFIR com artefatos de VM de laboratório após cenário de intrusão controlada.",
        "Cloud Metadata Service Attack": "Sandbox cloud de treino para validar risco de metadata service e aplicar controles de identidade.",
        "Service Principal Abuse": "Tenant de laboratório para auditoria de permissões excessivas de service principals e hardening.",
        "Domain Fronting for C2": "Exercício red team em ambiente segregado para estudar evasão de rede e respostas de monitoramento."
    };

    if (exactLabs[termObj.term]) return exactLabs[termObj.term];

    const name = termObj.term.toLowerCase();
    if (name.includes("sqli") || name.includes("xss") || name.includes("csrf") || name.includes("idor") || name.includes("web")) {
        return "Lab web com DVWA/OWASP Juice Shop em VMs separadas para exploração controlada e validação de correções.";
    }
    if (name.includes("kerberoast") || name.includes("dcsync") || name.includes("ntlm") || name.includes("ticket") || name.includes("ad")) {
        return "Lab AD com 1 controlador de domínio e 1-2 estações para simular abuso de identidade e reforçar detecção.";
    }
    if (name.includes("mobile") || name.includes("android") || name.includes("apk") || name.includes("ios") || name.includes("frida")) {
        return "Lab mobile com emulador Android/iOS de teste para análise de app, instrumentação e validação de segurança.";
    }
    if (name.includes("malware") || name.includes("loader") || name.includes("hollowing") || name.includes("stealer")) {
        return "Lab de malware em rede isolada com snapshots de VM (Kali, FLARE VM, REMnux) para análise segura.";
    }
    if (name.includes("forensic") || name.includes("dfir") || name.includes("timeline") || name.includes("registry") || name.includes("mft")) {
        return "Lab DFIR com imagem de disco/memória de VM de incidente simulado para triagem e reconstrução cronológica.";
    }
    if (name.includes("cloud") || name.includes("oauth") || name.includes("saml") || name.includes("identity") || name.includes("principal")) {
        return "Sandbox cloud de laboratório (tenant de treino) para avaliar identidade, permissões e telemetria em ambiente controlado.";
    }
    if (name.includes("phishing") || name.includes("social") || name.includes("fraud") || name.includes("carding")) {
        return "Simulação social em laboratório com contas fictícias para treino de detecção, resposta e conscientização.";
    }

    const byTag = {
        pentest: "Cenário red team em VMs (Kali + alvo vulnerável) para validar técnicas e cobertura de detecção.",
        network: "Topologia de laboratório com VMs segmentadas para simular tráfego ofensivo e monitoramento defensivo.",
        web: "Aplicação web vulnerável em laboratório para reproduzir falhas com segurança e validar mitigação.",
        mobile: "Ambiente mobile de teste com emuladores e app de laboratório para análise estática/dinâmica.",
        malware: "Rede isolada com snapshots para observação de comportamento malicioso sem risco ao ambiente real.",
        crypto: "Lab de criptografia para avaliação de implementação, chaves e resistência a ataques comuns.",
        social: "Exercício de engenharia social em contexto acadêmico com usuários e dados fictícios.",
        defense: "Cenário blue/purple team para medir visibilidade, detecção e resposta sobre eventos simulados.",
        forensics: "Caso forense em VM comprometida para coleta de artefatos, preservação e análise técnica."
    };

    return byTag[termObj.tag] || "Exercício prático em laboratório isolado com documentação de evidências e lições aprendidas.";
}
